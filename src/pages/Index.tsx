    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-36">
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          >
            See how your brand shows up across ChatGPT, Gemini, Claude, and Perplexity, not just if you're mentioned, but how you're positioned. Fast, secure, free!
          </motion.p>
          ...
          >
            <button
              ...
              style={{ padding: "0.875rem 2.5rem", background: "hsl(0 0% 100%)", color: "hsl(0 0% 0%)" }}
